...
func (c *greeterClient) SayHello(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/proto.Greeter/SayHello", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterSayHelloClient) CloseAndRecv() (*HelloResponse, error) {
...
func (x *greeterSayHelloServer) SendAndClose(m *HelloResponse) error {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "stream-client/hello.proto",
}
